...
import { GeolocationDeniedBanner, PreFlightDrawer } from '@/widgets/wtp-cta';
  ...
  return (
    <>
      <button
        ...
        aria-label={label}
        className="absolute bottom-4 left-1/2 z-30 flex -translate-x-1/2 items-center gap-2 rounded-full bg-emerald-600 px-5 py-2.5 text-sm font-semibold text-white shadow-xl hover:bg-emerald-700 active:scale-[0.98] disabled:cursor-wait disabled:opacity-80 lg:hidden"
      >
      ...
      <GeolocationDeniedBanner
        state={state}
        className="absolute right-4 bottom-20 left-4 z-30 lg:hidden"
      />
      <PreFlightDrawer
        open={preFlightOpen}
